...
I should also call out here that I work for Microsoft, which owns GitHub, and I also used to help run code.nasa.gov as I mentioned them both. These are my personal opinions.
The public can also read the code quickly without having to download and open large files, reducing friction for evaluation increases rates of reuse.

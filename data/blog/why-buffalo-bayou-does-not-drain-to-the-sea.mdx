...
geological story but simply what you can see in the REM and elevation profiles. You can find that 
more scientific piece in the [June 2025 issue of the HGS Bulletin](https://newhgs.org/documents/bulletin_archives/Final%20-6_2_25%20June%20Bulletin.pdf).
This blog post is mostly just to post some pretty pictures strung together with
a bit of context focused on the present date elevation aspects. You can find the data processing details
and how to replicate in the GitHub repository: [JustinGosses/buffalo_bayou_geology_REM](https://github.com/JustinGOSSES/buffalo_bayou_geology_REM)
...
[Buffalo Bayou](https://github.com/JustinGOSSES/buffalo_bayou_geology_REM/blob/main/notebooks/ETL_v1clean.ipynb).
